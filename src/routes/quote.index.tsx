              ...
              {step === 1 && (
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <Field label="Lab/Institution Name" placeholder="National Research Facility" />
                    <div className="md:col-span-2">
                      <Field label="Facility Location" placeholder="City, Country" />
                    </div>
                  </div>
                      ...
                      <div className="flex-grow">
                        ...
                        <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                          ...
                          <div>
                            ...
                            <select className="h-11 w-full rounded-lg border border-input bg-surface px-3 text-sm outline-none focus:border-secondary">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                    <div>
                      ...
                      <select className="h-12 w-full rounded-lg border border-input bg-surface px-3 text-sm outline-none focus:border-secondary">
