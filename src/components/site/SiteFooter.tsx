      ...
      <div className="container-page grid grid-cols-1 gap-10 py-16 md:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="mailto:info@livanlabsupplies.co.ug"
              aria-label="Email"
              className="flex h-9 w-9 items-center justify-center rounded-full bg-white/10 transition-colors hover:bg-white/20"
            >
        ...
        <div className="flex flex-col gap-2">
          ...
          <span className="text-sm text-primary-foreground/70">After-Sales Service</span>
        </div>

        <div className="col-span-1 flex flex-col items-center justify-between gap-3 border-t border-primary-foreground/20 pt-6 md:col-span-2 lg:col-span-4 md:flex-row">
